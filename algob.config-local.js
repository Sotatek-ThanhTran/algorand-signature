...
let accounts = mkAccounts([
  ...
  {
    name: "user1",
    addr: "3BQ7FA422IEDJUWEQ4PYVNOAW6RSVKF6AKFY23KNFUABCNIERH3MT74QKY",
    mnemonic:
      "fashion lucky salon end inflict cable stadium physical busy design swing shuffle wreck coil mobile round copper leader banner swing buddy fold staff above fame",
  },
  {
    name: "user2",
    addr: "IEHT7QRSEOJE5KQOV44A46XKGPCAUYJZCQ53K72MZIJQJVBEK4RBJKEOGQ",
    mnemonic:
      "foster together glad cage three light theme piece fee gain immune garbage category sell desert friend dad oil actor chunk raccoon bus tenant abandon swear",
  },
]);
